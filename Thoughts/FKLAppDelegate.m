...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    //UITabBarController *controller = (UITabBarController *)navigationController.topViewController;
    for (UIViewController *v in navigationController.viewControllers)
    {
        if ([v isKindOfClass:[UINavigationController class]])
        {
            for (UIViewController *vc in v.childViewControllers)
            {
                if ([vc isKindOfClass:[FKLForcesController class]])
                {
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Thoughts" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Thoughts.sqlite"];
